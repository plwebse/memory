...
public class GamePlayerVsNetworkPlayer extends JPanel {
    ...
    public void waitingForClient() {
        ...
        for (PlayerStatusPanel playerStatusPanel : getPlayerStatusPanels()) {
            playerStatusPanel.updateStatus(messageWaitingForClient);
        }
    }
    ...
    public void notConnected() {
        ...
        for (PlayerStatusPanel playerStatusPanel : getPlayerStatusPanels()) {
            playerStatusPanel.updateStatus(messageNotConnected);
        }
    }
    ...
    public void clientWon() {
        ...
        for (PlayerStatusPanel playerStatusPanel : getPlayerStatusPanels()) {
            playerStatusPanel.updateStatus(messageClientWon);
    ...
    public void serverWon() {
        ...
        for (PlayerStatusPanel playerStatusPanel : getPlayerStatusPanels()) {
            playerStatusPanel.updateStatus(messageServerWon);
            playerStatusPanel.updatePairStatus(0, 0);
        }
    ...
    public void disConnected() {
        ...
        for (PlayerStatusPanel playerStatusPanel : getPlayerStatusPanels()) {
            playerStatusPanel.updateStatus(messageDisconnected);
        }
    ...
    private List<PlayerStatusPanel> getPlayerStatusPanels() {
        return Arrays.asList(playerStatusPanelClient, playerStatusPanelServer);
    }
}
